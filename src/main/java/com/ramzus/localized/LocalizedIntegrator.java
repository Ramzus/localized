...
import com.ramzus.localized.event.ReadEventListener;
import com.ramzus.localized.event.WriteEventListener;
import com.ramzus.localized.locale_resolver.DefaultLocaleResolver;
import com.ramzus.localized.event.DeleteEventListener;
...
public class LocalizedIntegrator implements Integrator {
    ...
    public void disintegrate(SessionFactoryImplementor sessionFactory, SessionFactoryServiceRegistry serviceRegistry) {
        //override disintegrate to be a null method
    }
}
